...
function AdUser(props) {
  let navigate = useNavigate();
  const [providerName, setProviderName] = React.useState("");

  console.log("this is aduser");
  console.log(props);
  ...
  React.useEffect(() => {
    ...
    if (token) {
      ...
      setProviderName(decodedToken.admin.name);
    }
  }, []);
  return (
    <div className="dashboard">
      ...
      <header className="menu-wrap">
        <figure className="user">
          ...
          <figcaption>{providerName}</figcaption>
        </figure>
        <nav>
          <section className="dicover">
            ...
            <ul>
              ...
              <li>
                <a
                  onClick={() => navigate("/adminscholarships")}
              ...
              <li>
                <a onClick={() => navigate("/createscholarship")}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={24}
                    height={24}
